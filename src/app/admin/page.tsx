...
export default async function AdminDashboard() {
  ...
  const byCategory = {
    ...
    mobilier:    projects.filter(p => p.category === 'mobilier').length,
  };

  const cards = [
    { href: '/admin/projects', label: 'Projets', value: projects.length, sub: `${byCategory.interieur} intérieur · ${byCategory.residentiel} résidentiel · ${byCategory.bureaux} bureaux · ${byCategory.commercial} commercial · ${byCategory.mobilier} mobilier` },
